...
module.exports = {
	...
	// prefix: local url prefix, always ends with /. any request except root that doesn't contain this // prefix will be forward to remote server. by using this config you can map http://yourserver.com/prefix/ to the directory configured in 'root'
