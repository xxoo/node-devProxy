...
// requires devProxy 0.33 or higher which can be installed via npm
...
module.exports = {
	...
	// 当访问根目录时是否会重定向至local.prefix
	// whether redirect to prefix when accessing root path
	homeRedirect: true,
	...
	// homeRedirect: 当访问根目录时会重定向至prefix
	...
	// homeRedirect: redirect to prefix when accessing root path
